    ...
    return (
        <>
            <div className={styles["comment-container"]}>
                ...
                <img className={styles["comment-user-image"]} src={comment.user.image ? `https://kuzmagram-api.onrender.com/${comment.user.image}` : require("../../../../../../../images/user-profile-image.png")} alt="user" />
